  ...
  return (
    ...
    <div className={`bg-[#090017] text-white ${styles.gradientBg} px-5`}>
        ...
        <div className='container mx-auto flex flex-col md:flex-row gap-4 px-5'>
            ...
            <div className='w-full md:w-1/2 justify-center items-center md:items-start flex gap-12 flex-col pb-20'>
            ...
            <div className='w-full md:w-1/2 flex justify-center relative'>
                <Image className='absolute w-10/12 top-[0px] ' src="/images/trama.svg" alt="Uruguay" width={489} height={550} />
                <Image className='z-10 w-4/5 md:w-[489px] pt-2' src={imageSrc} alt="Pedidos Ya Plus" width={489} height={550} />
